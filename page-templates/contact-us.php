    ...
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-lg-12 col-md-10">
                <span
                    class="hero-common-subheading secondary-color d-block fst-normal mb-3 position-relative"><?= get_field('header_title');?></span>
                <h1 class="career-common-heading text-white mb-3 fw-normal"><?= get_field('header_sub_title');?></h1>
                <p class="common-description text-white m-0"><?= get_field('header_desc');?></p>
                <div class="d-flex justify-content-center mt-5 custom-btn pt-5">
                    <a class="custom-btn-animation button-link btn rounded-0 text-white " href="#contact-form">
                        <span class="button-content-wrapper">
                            <span class="button-text"><?= get_field('header_button_text');?>
