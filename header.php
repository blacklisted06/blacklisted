...
<head>
    ...
    <link rel="shortcut icon" href="<?= site_url(); ?>/wp-content/uploads/2025/02/Creative-Agency-Blacklisted-Agency.webp" type="image/webp" />
    <link rel="icon" href="<?= site_url(); ?>/wp-content/uploads/2025/02/Creative-Agency-Blacklisted-Agency.webp" type="image/webp" />
	 <?= get_field('schema_for_page', get_the_ID()); ?>
   	<?php wp_head();
...
<body <?php body_class(); ?>>
  ...
  <div class="main-lines" aria-hidden="true">
    <div class="container w-100 h-100">
        <div class="outer-lines d-flex justify-content-center align-items-center  w-100 h-100">
	...
	<header class="header transparent-header text-white w-100">
	      <div class="header-main-lines" aria-hidden="true">
    <div class="container w-100 h-100">
        <div class="outer-lines d-flex justify-content-center align-items-center  w-100 h-100">
            <div class="row justify-content-center w-100 h-100">
                <div class="col-md-6 col-6 p-0">
