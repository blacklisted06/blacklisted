...
$page_bg_class = 'bg-light-yellow';  ?>
    ...
    ?>
    <footer class="footer main-footer footer-section-padding <?= $page_bg_class; ?>">
        <div class="container">
            <div class="row footer__blocks-wrapper">
                ...
                <div class="col-md-3 mb-3">
                    <div class="footer-block">
                        <span class="footer-heading text-uppercase primary-color mb-3 d-block">
                        ...
                        <ul class="footer-details-content list-unstyled">
                            ...
                            <li class="text-black">
                                <a href="mailto:<?= $contact_email ?>" class="text-black">
                                    <?= $contact_email ?>
                                </a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li class="text-black">
                                <a href="tel:<?= $contact_number ?>" class="text-black">
                                    <?= $contact_number ?>
                                </a>
                            </li>
                            <?php endif; ?>
            ...
            <div class="container text-center my-3 py-3 py-md-5">
                <span class="social-heading text-black mb-4 text-uppercase d-block">Engage and Follow</span>
            ...
            <div class="container">
                <div class="footer-bottom-links d-flex justify-content-between align-items-center py-md-4 py-2">
                    <div><a href="<?= site_url('founder') ?>">
                            <p class="founder-link mb-0 text-black fw-medium">
                                <?= 'Founded by Mohit Sharma'; ?>
                            </p>
                        </a>
                    </div>
